...
export const ingredientCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'agua_tonica',      label: 'Água Tônica',       emoji: '🫧' },
      { id: 'refrigerante_cola',label: 'Refrigerante Cola', emoji: '🥤' },
      { id: 'suco_de_abacaxi',  label: 'Suco de Abacaxi',   emoji: '🍍' },
      { id: 'suco_de_cranberry',label: 'Suco de Cranberry', emoji: '🍒' },
      { id: 'suco_de_toranja',  label: 'Suco de Toranja',   emoji: '🍊' },
      { id: 'suco_de_tomate',   label: 'Suco de Tomate',    emoji: '🍅' },
